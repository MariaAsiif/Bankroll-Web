                    ...
                    <div className=''>
                        <ul>
                            <li>
                                ...
                                <p className='lg:max-w-[300px]  pt-2 text-[14px] lg:pl-[3rem] '>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                            </li>
                            <li className='py-5'>
                                <div className='flex items-center'>
                    ...
                    <div className='lg:px-2 '>
                        <ul className=''>
                            <li>
                                ...
                                <p className='  pt-2 text-[14px] lg:pl-[3rem]   lg:max-w-[300px]'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                            </li>
                            <li className='py-5'>
                                <div className='flex items-center '>
                            ...
                            <li>
                                ...
                                <p className=' pt-2 text-[14px] lg:max-w-[300px]  lg:pl-[3rem] '>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                            </li>
                        </ul>
