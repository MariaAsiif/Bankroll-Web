            ...
            <div className='lg:mx-20 mx-5 lg:mb-4 mb-[3rem] lg:mt-0 mt-[3rem] '>
                <div className="lg:flex  items-center">
                        ...
                        <ul>
                            <li>
                                <div className='flex items-center'>
                                    <img className='lg:w-[15%] object-cover' src={limit} alt="icon" />
                            ...
                            <li className='py-[3rem]'>
                                <div className='flex items-center '>
                                    <img className='lg:w-[15%] object-contain  md:ml-3 ' src={video} alt="icon" />
                    ...
                    <div className=''>
                        <ul className=''>
                            <li>
                                <div className='flex items-center'>
                                    <img className='lg:w-[10%] object-contain  md:ml-3  ' src={business} alt="icon" />
                            ...
                            <li>
                                <div className='flex items-center'>
                                    <img className='lg:w-[20%] w-[17%] md:w-[12%] object-cover lg:-ml-0 md:ml-0 -ml-2' src={doller} alt="icon" />
                ...
                <div className="grid lg:grid-cols-3  pt-3">
                    <div className="flex flex-col justify-center items-start lg:pb-0 lg:pt-0 md:pb-10 md:pt-10 pb-10 pt-20 ">
                        <div className='flex items-center '>
                            <img className='lg:w-[15%]  object-cover' src={budges} alt="icon" />
                    ...
                    <div className=" lg:pb-0 md:pb-10 pb-10  ">
                        <div className='flex items-center '>
                            <img className='lg:w-[10%] object-cover' src={sub} alt="icon" />
                    ...
                    <div className="flex lg:pb-0 pb-10 justify-end items-end ">
                        <div className=" ">
                            <div className='flex items-center '>
                                <img className='lg:w-[10%] object-cover' src={peer} alt="icon" />
                ...
                <div className="grid lg:grid-cols-3  pt-3">
                    <div className="flex flex-col justify-center items-start lg:pb-0 pb-10 md:pb-10 ">
                        <div className='flex items-center '>
                            <img className='lg:w-[15%] object-cover' src={app} alt="icon" />
                    ...
                    <div className="lg:pb-0 pb-10 md:pb-10  ">
                        <div className='flex items-center '>
                            <img className='lg:w-[10%] object-cover' src={bankroll} alt="icon" />
                    ...
                    <div className="lg:pb-0 pb-10 md:pb-10">
                        <div className="lg:pl-20  ">
                            <div className='flex items-center '>
                                <img className='lg:w-[8%] object-cover' src={stash} alt="icon" />
                ...
                <div className="grid lg:grid-cols-3  pt-3">
                    <div className="flex flex-col justify-center items-start lg:pb-0 pb-10 md:pb-10 ">
                        <div className='flex items-center justify-start self-start '>
                            <img className='lg:w-[15%] object-cover' src={bankcards} alt="icon" />
                    ...
                    <div className=" lg:pb-0 pb-10 md:pb-10">
                        <div className='flex items-center '>
                            <img className='lg:w-[10%] object-cover' src={chat} alt="icon" />
