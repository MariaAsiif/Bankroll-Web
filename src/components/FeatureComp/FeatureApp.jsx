        ...
        <>
            ...
            <div className='mx-20 mt-[4rem]'>
                <div className="flex items-center">
                    <div className='w-full'>
                        <ul>
                            <li>
                                ...
                                <p className='max-w-[300px] pt-2 text-[14px]'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                            </li>
                            <li className='py-5'>
                                <div className='flex items-center'>
                                    <img className='w-[15%] object-cover' src={cash} alt="icon" />
                                     <h2 style={{fontWeight:'700'}} className=' text-[18px] text-[#4965E0]'>Multiple cash</h2>
                                </div>
                                <p className='max-w-[300px] pt-2 text-[14px]'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                            </li>
                            <li>
                                <div className='flex items-center'>
                                    <img className='w-[15%] object-cover' src={ref} alt="icon" />
                                     <h2 style={{fontWeight:'700'}} className=' pt-5 pl-1 text-[18px] text-[#4965E0]'>Referrals and Royalties( R &R)</h2>
                                </div>
                                <p className='max-w-[300px] pt-2 text-[14px]'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                            </li>
                        </ul>
                    ...
                    <div className='bg-featureMobile-img bg-contain bg-center bg-no-repeat w-full'>
                    ...
                    <div className='px-2 w-full'>
                        <ul className='m-0 p-0'>
                            <li>
                                ...
                                <p className='  pt-2 text-[14px]'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
                            </li>
                            <li className='py-5'>
                                <div className='flex items-center'>
                                    <img className='w-[15%] object-cover' src={video} alt="icon" />
