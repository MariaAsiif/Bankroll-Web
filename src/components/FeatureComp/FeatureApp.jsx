...
import video from '../../assests/images/vidio.png'
            ...
            <div className='lg:mx-20 mx-5 lg:mb-4 mb-[3rem] lg:mt-0 mt-[3rem] '>
                <div className="lg:flex  items-center">
                        ...
                        <ul>
                            <li>
                                <div className='flex items-center'>
                                    <img className='lg:w-[10%] object-cover' src={limit} alt="icon" />
                            ...
                            <li className='py-[3rem]'>
                                <div className='flex items-center '>
                                    <img className='lg:w-[10%] object-contain   ' src={video} alt="icon" />
                                    <h2 style={{ fontWeight: '700' }} className=' text-[18px] text-[#4965E0]'>Video & Audio Chat</h2>
                                </div>
                    ...
                    <div className='bg-featureMobile-img bg-contain bg-center bg-no-repeat '>
                        <img src={ovelImage} alt="ovel_image" className='object-cover w-full lg:w-auto' />
                    </div>
                    <div className=''>
                        <ul className=''>
                            <li className="lg:-ml-10">
                                <div className='flex items-center'>
                                    <img className='lg:w-[10%] object-contain  ' src={business} alt="icon" />
                                ...
                                <div className='flex items-start '>
                                    ...
                                    <p className='  pt-2 text-[14px] pl-[3rem]  lg:max-w-[350px]'>Where is the fun in only having one handle? With BankRoll you
                            ...
                            {/*  */}
                            <li className='lg:py-[5rem] py-[3rem]'>
                                <div className='flex items-center'>
                                    <img className='lg:w-[15%] md:w-[8%] w-[12%] object-cover' src={cash} alt="icon" />
                                    <h2 style={{ fontWeight: '700' }} className='  lg:px-2 px-3 text-[18px] text-[#4965E0]'>Multiple Coin</h2>
                                </div>


                                <p className='lg:max-w-[350px]  pt-2 text-[14px] lg:pl-[3.5rem] '>Enjoy having all of the money in the world at your finger tips. Fiat
                            ...
                            <li className=''>
                                ...
                                <p className='  text-[14px] lg:max-w-[350px]  lg:pl-[3rem] '> Skeptical about the stability of crypto? The United States Dollar
                ...
                <div className="grid lg:grid-cols-3  pt-3">
                    <div className="flex flex-col justify-center items-start lg:pb-0 lg:pt-0 md:pb-10 md:pt-10 pb-10 pt-20 ">
                        <div className='flex items-center '>
                            <img className='lg:w-[15%]  object-cover lg:mt-5' src={budges} alt="icon" />
                            <h2 style={{ fontWeight: '700' }} className=' pt-3 lg:pl-3 px-3 text-[18px] text-[#4965E0]'>Badges Of Honor</h2>
                        </div>
                        <p className='lg:max-w-[300px]  pt-2  text-[14px] lg:pl-[2.5rem] '>A good reputation is better than being rich. Maybe. Become a verified BankRoller and receive your first profile badge. Level up by doing good business and conducting yourself like you are supposed to within the app. Other users will take notice and feel safer dealing with you.</p>
                    </div>
                    <div className=" lg:pb-0 md:pb-10 pb-10  ">
                        <div className='flex items-center '>
                            <img className='lg:w-[8%] object-cover lg:mt-5' src={sub} alt="icon" />
                            <h2 style={{ fontWeight: '700' }} className=' pt-3 lg:pl-2 px-3 text-[18px] text-[#4965E0]'>Sub Life</h2>
                        </div>
                        <p className='lg:max-w-[300px]  pt-2  text-[14px] lg:pl-[2.5rem] '>Subscription payments keep life interesting. Setup recurring payments for the things you can't live without. Hulu. Netflix. Only Fans. A dozen or so maxed out credit cards.</p>
                    </div>
                    ...
                    <div className="flex lg:pb-0 pb-10  ">
                        <div className=" lg:pl-[3.5rem] ">
                            ...
                            <p className='lg:max-w-[350px]  pt-2  text-[14px] lg:pl-[2.8rem] '>What do you do when someone asks for a loan? If you can't change your phone number then you can always use our Front feature. Front allows BankRollers to create smart contracts detailing the terms and interest rates they are most comfortable with. Our app makes it worth the risk if you can afford it.</p>
                        </div>
                    </div>
                </div>
                <div className="grid lg:grid-cols-3  pt-3">
                    <div className="flex flex-col justify-center items-start lg:pb-0 pb-10 md:pb-10 ">
                        <div className='flex items-center '>
                            <img className='lg:w-[15%] object-cover lg:mt-5' src={app} alt="icon" />
                            <h2 style={{ fontWeight: '700' }} className=' pt-3 lg:pl-3 px-3 text-[18px] text-[#4965E0]'>App To App</h2>
                        </div>
                        <p className='lg:max-w-[300px]  pt-2  text-[14px] lg:pl-[2.5rem] '>BankRoll is just one of many of hundreds of Fintech apps out there. It can be hard to settle on just one. So we decided to allow app to app payments so our users can send or receive their coin regardless of whether the other party is a BankRoller or not. The epicenter of online transactions and mobile payments and being the center of attention is the same thing.</p>
                    </div>
                    <div className="lg:pb-0 pb-10 md:pb-10  ">
                        <div className='flex items-center '>
                            <img className='lg:w-[8%] object-cover lg:mt-5'  src={bankroll} alt="icon" />
                            <h2 style={{ fontWeight: '700' }} className=' pt-3 lg:pl-2 px-3 text-[18px] text-[#4965E0]'>BankRoll Community</h2>
                        </div>
                    ...
                    <div className="lg:pb-0 pb-10 md:pb-10">
                        <div className="lg:pl-[4rem]  ">
                            ...
                            <p className='lg:max-w-[300px] pt-2 text-[14px] lg:pl-[2.5rem] '>Stash savings in a safe place that is FDIC insured. Participate in BankRoll community investment opportunities and earn interest on your coin.</p>
                        </div>
                    </div>
                </div>
                <div className="grid lg:grid-cols-3  pt-3">
                    <div className="flex flex-col justify-center items-start lg:pb-0 pb-10 md:pb-10 ">
                        <div className='flex items-center justify-start self-start '>
                            <img className='lg:w-[15%] object-cover lg:mt-5 ' src={bankcards} alt="icon" />
                            <h2 style={{ fontWeight: '700' }} className=' pt-3 lg:pl-3 px-3 text-[18px] text-[#4965E0]'>BankRoll Cards</h2>
                        </div>
                        <p className='lg:max-w-[300px]  pt-2  text-[14px] lg:pl-[2.5rem] '>Instantly create virtual cards and set them up to manage various expenses.
                            Exclusive/Premium users will be introduced to our bronze metal cards.</p>
                    </div>
                    <div className=" lg:pb-0 pb-10 md:pb-10">
                        <div className='flex items-center '>
                            <img className='lg:w-[8%] object-cover' src={chat} alt="icon" />
                            <h2 style={{ fontWeight: '700' }} className=' pt-3 lg:pl-2 px-3 text-[18px] text-[#4965E0]'>Chat Support</h2>
                        </div>
                        <p className='lg:max-w-[350px]  pt-2  text-[14px] lg:pl-[2.5rem] '>Reach out to us anytime for help with anything related to your BankRoll account.</p>
                    </div>
