        ...
        <>
            <div className='flex justify-between items-center'>
                ...
                <div className='flex items-center justify-between'>
                    <button onClick={() => setShow(true)} className='flex items-center w-fit px-5 py-2 text-white text-[16px]   rounded-lg bg-gradient-to-r from-[#4965E0] to-[#896CDD] '>{buttonTitle} <BsPlus className='text-[20px] text-white' /></button>
                    <div className='mx-3'>
