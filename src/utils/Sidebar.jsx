...
function Sidebar({
    ...
    return (
        <div>
            ...
            <div id="sidebar" ref={sidebar} className={`flex flex-col  absolute z-60  left-0 top-0 lg:left-0  
                ...
                <div>
                    <div className="h-full pb-2">
                        ...
                        <ul className=" text-start flex flex-col items-center justify-center ">
                            <li
                                className={`${location === "/partner" ? "border-b border-white  " : " w-full  my-3 px-6 cursor-pointer group hover:bg-black hover:text-white uppercase "
                                    } `}
                            >
                                <Link to="/businessLogin">
                                    <h2 className="text-[20px] pt-2 font-medium font-roboto text-black group-hover:text-white">
                                        Home
                                    </h2>
                                </Link>
                            </li>
                            <li
                                className={`${location === "/customer" ? "border-b border-white  " : "w-full  my-3 px-6 cursor-pointer group hover:bg-black hover:text-white uppercase "
                                    } `}
                            >
                                <Link to="/signin">
                                    <h2 className="text-[20px] pt-2 font-medium font-roboto text-black group-hover:text-white">
                            ...
                            <li
                                className={`${location === "/ourservices" ? "border-b border-white  " : "w-full  my-3 px-6 cursor-pointer group hover:bg-black hover:text-white uppercase "
                                    } `}
                            >
                            ...
                            <li
                                className={`${location === "/aboutus" ? "border-b border-white  " : "w-full  my-3 px-6 cursor-pointer group hover:bg-black hover:text-white uppercase "
                                    } `}
                            >
                                <Link to="/signin">
                                    <h2 className="text-[20px] pt-2 font-medium font-roboto text-black group-hover:text-white">
